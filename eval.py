...
def eval_dataset(dataset_path, width, softmax_temp, opts):
    ...
    if opts.multiprocessing:
        ...
        results = _eval_dataset(model, dataset, width, softmax_temp, opts, opts.device)
    ...
    for batch in tqdm(dataloader, disable=opts.no_progress_bar):
        ...
        with torch.no_grad():
            if opts.decode_strategy in ('sample', 'greedy'):
                ...
                sequences, costs = model.sample_many(batch, batch_rep=batch_rep, iter_rep=iter_rep, opts=opts)
        ...
        # torch.save([sequences,costs],'./outputs/cvrp_50/attn/tour_cost.pt')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--results_dir', default='results_test', help="Name of results directory")
